...
describe('ScenarioManagementService', () => {
    ...
    let scenarioService;
    beforeEach(() => {
        scenarioService = new scenarioManagement_service_1.ScenarioManagementService();
    });
    ...
    describe('listScenarios', () => {
        ...
        beforeEach(async () => {
            ...
            scenarios = await Promise.all(testData.map(data => scenarioService.registerScenario(data)));
        });
        ...
        it('should sort results', async () => {
            const result = await scenarioService.listScenarios(undefined, { field: 'name', direction: 'asc' });
        ...
        it('should combine filter, sort, and pagination', async () => {
            const result = await scenarioService.listScenarios({ mediaType: 'web' }, { field: 'name', direction: 'desc' }, 1, 1);
            expect(result.items).toHaveLength(1);
